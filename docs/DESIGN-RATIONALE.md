...
| Zoomable interfaces can preserve one navigable information world across scales. [Bederson & Hollan, Pad++](https://www.cs.columbia.edu/graphics/courses/csw4170/resources/bedersonHollanUIST94.pdf) | Far zoom reduces large views to deterministic semantic landmarks; mid zoom restores concepts; near zoom adds essences, phases, relation counts, and full edge verbs. |
...
- AI-suggested theory should remain visibly provisional until a human accepts it. Every seeded entity is marked `ai-proposed`; the interface does not autonomously promote generated material into accepted canon.
